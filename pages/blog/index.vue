<template>
    <main class="w-full min-h-screen h-auto flex flex-col items-center">
        <h1 class="text-4xl font-bold text-center mb-5">Personal blog</h1>
        <IconField class="w-2/3 mr-1 rounded-md h-auto bg-white my-10">
            <InputIcon icon="pi pi-search" class="h-full" />
            <InputText placeholder=" Search" class="h-full w-full ml-2" v-model="search" />
        </IconField>
        <div class="w-full h-auto rounded-md flex flex-col items-center" v-if="search != ''">
