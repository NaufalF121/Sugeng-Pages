    ...
    >
      ...
      >
        ...
        <!-- <div class="w-full mt-10 grid grid-cols-5 row-auto
                    ...
                    <div class="justify-center items-center">
                        <Icon name="uil:react" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:nodejs" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:vue" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:pytorch-icon" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:tailwindcss-icon" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:docker-icon" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:linux-tux" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:github-icon" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:pandas-icon" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:numpy" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:nextjs-icon" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:aws-s3" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:git-icon" size="100" />
                    </div>
                    <div class="justify-center items-center">
                        <Icon name="logos:azure-icon" size="100" />
                    </div>
